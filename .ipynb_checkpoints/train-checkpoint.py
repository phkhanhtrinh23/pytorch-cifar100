...
if __name__ == '__main__':
    ...
    parser.add_argument('-finetune', type=bool, default=False, help='fine tuning')
    parser.add_argument('-weightspath', type=str, default=None, help='path to the weights file')
...
#                 )
    ...
    if args.resume:
        ...
        print('loading weights file {} to fine tuning.....'.format(args.weightspath))
        net.load_state_dict(torch.load(args.weightspath),strict=False)
    ...
    for epoch in range(1, settings.EPOCH + 1):
        ...
        if epoch > settings.MILESTONES[0] and best_acc < acc:
            ...
            if args.net.split("_")[-1] != "lora":
                torch.save(net.state_dict(), weights_path)
            else:
                print("saving lora weights")
                torch.save(lora.lora_state_dict(net), weights_path)
            best_acc = acc
            continue
